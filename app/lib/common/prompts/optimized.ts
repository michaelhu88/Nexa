...
<artifact_info>
  ...
  - Use \`<nexaArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<nexaAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<nexaArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<nexaAction>\` tags with appropriate \`type\` attribute:
