      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-nexa-elements-textPrimary">Vercel Connection</h3>
          </div>
        </div>
        ...
        {!connection.user ? (
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-nexa-elements-textSecondary mb-2">Personal Access Token</label>
              <input
                type="password"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg">
              ...
              <img
                ...
                crossOrigin="anonymous"
                alt="User Avatar"
                className="w-12 h-12 rounded-full border-2 border-nexa-elements-borderColorActive"
              />
              <div>
                <h4 className="text-sm font-medium text-nexa-elements-textPrimary">
            ...
            {fetchingStats ? (
              <div className="flex items-center gap-2 text-sm text-nexa-elements-textSecondary">
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-nexa-elements-textPrimary mb-3 flex items-center gap-2"
                >
                ...
                {isProjectsExpanded && connection.stats?.projects?.length ? (
                  <div className="grid gap-3">
                    {connection.stats.projects.map((project) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block p-4 rounded-lg border border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className="text-sm font-medium text-nexa-elements-textPrimary flex items-center gap-2">
                              <div className="i-ph:globe w-4 h-4 text-nexa-elements-borderColorActive" />
                              {project.name}
                            </h5>
                            <div className="flex items-center gap-2 mt-2 text-xs text-nexa-elements-textSecondary">
                              {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                                <>
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-nexa-elements-borderColorActive"
                                  >
                          ...
                          {project.framework && (
                            <div className="text-xs text-nexa-elements-textSecondary px-2 py-1 rounded-md bg-[#F0F0F0] dark:bg-[#252525]">
                              <span className="flex items-center gap-1">
                  ...
                  <div className="text-sm text-nexa-elements-textSecondary flex items-center gap-2">
