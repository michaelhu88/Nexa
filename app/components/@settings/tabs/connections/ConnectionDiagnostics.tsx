  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-lg bg-nexa-elements-background dark:bg-nexa-elements-background-depth-2 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive/70 dark:hover:border-nexa-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:github-logo text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-nexa-elements-textPrimary dark:text-nexa-elements-textPrimary">
              GitHub Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasGithubConnection && (
                <>
                  <div className="text-xs text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:user w-3.5 h-3.5 text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent" />
                    User: {diagnosticResults.localStorage.githubConnectionParsed?.user?.login || 'N/A'}
                  </div>
                  <div className="text-xs text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:check-circle w-3.5 h-3.5 text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent" />
                    API Status:{' '}
                    <Badge
                      variant={
              ...
              {!diagnosticResults.localStorage.hasGithubConnection && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="mt-auto self-start hover:bg-nexa-elements-item-backgroundActive/10 hover:text-nexa-elements-textPrimary dark:hover:bg-nexa-elements-item-backgroundActive/10 dark:hover:text-nexa-elements-textPrimary transition-colors"
                >
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-sm text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary flex items-center gap-2">
        ...
        <div className="p-4 rounded-lg bg-nexa-elements-background dark:bg-nexa-elements-background-depth-2 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive/70 dark:hover:border-nexa-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-bolt:netlify text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-nexa-elements-textPrimary dark:text-nexa-elements-textPrimary">
              Netlify Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-nexa-elements-background dark:bg-nexa-elements-background-depth-2 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive/70 dark:hover:border-nexa-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:vercel text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-nexa-elements-textPrimary dark:text-nexa-elements-textPrimary">
              Vercel Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-nexa-elements-background dark:bg-nexa-elements-background-depth-2 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive/70 dark:hover:border-nexa-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:supabase text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-nexa-elements-textPrimary dark:text-nexa-elements-textPrimary">
              Supabase Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasSupabaseConnection && (
                <>
                  <div className="text-xs text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary mt-2 flex items-center gap-1.5 truncate">
                    <div className="i-ph:link w-3.5 h-3.5 text-nexa-elements-item-contentAccent dark:text-nexa-elements-item-contentAccent flex-shrink-0" />
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 hover:bg-nexa-elements-item-backgroundActive/10 hover:text-nexa-elements-textPrimary dark:hover:bg-nexa-elements-item-backgroundActive/10 dark:hover:text-nexa-elements-textPrimary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <Collapsible open={showDetails} onOpenChange={setShowDetails} className="w-full">
            <CollapsibleTrigger className="w-full">
              <div className="flex items-center justify-between p-4 rounded-lg bg-nexa-elements-background dark:bg-nexa-elements-background-depth-2 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor hover:border-nexa-elements-borderColorActive/70 dark:hover:border-nexa-elements-borderColorActive/70 transition-all duration-200">
                ...
                <ChevronDownIcon
                  className={classNames(
                    'w-4 h-4 transform transition-transform duration-200 text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary',
            ...
            <CollapsibleContent className="overflow-hidden">
              <div className="p-4 mt-2 rounded-lg bg-nexa-elements-background-depth-2 dark:bg-nexa-elements-background-depth-1 border border-nexa-elements-borderColor dark:border-nexa-elements-borderColor">
                <pre className="text-xs overflow-auto max-h-96 text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary">
