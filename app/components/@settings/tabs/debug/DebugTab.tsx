    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="i-ph:package text-nexa-elements-textSecondary w-4 h-4" />
          <span className="text-base text-nexa-elements-textPrimary">
            {title} Dependencies ({deps.length})
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm text-nexa-elements-textSecondary">{isOpen ? 'Hide' : 'Show'}</span>
          <div
            className={classNames(
              'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-nexa-elements-textSecondary',
              isOpen ? 'rotate-180' : '',
            )}
          />
        </div>
          ...
          <div className="space-y-2 p-4">
            {deps.map((dep) => (
              <div key={dep.name} className="flex items-center justify-between text-sm">
                <span className="text-nexa-elements-textPrimary">{dep.name}</span>
                <span className="text-nexa-elements-textSecondary">{dep.version}</span>
              </div>
            ))}
          </div>
        </ScrollArea>
              ...
              {exportFormats.map((format) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-nexa-elements-textSecondary mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-nexa-elements-textSecondary">Errors</div>
          </div>
          ...
          <div className="text-xs text-nexa-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div
              className={classNames(
                'w-3.5 h-3.5',
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-nexa-elements-textSecondary">Memory Usage</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-nexa-elements-textSecondary">Page Load Time</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm text-nexa-elements-textSecondary">Network Speed</div>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <span
              className={classNames(
        ...
        <div className="md:col-span-4 p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A] hover:border-purple-500/30 transition-all duration-200 h-[260px] flex flex-col">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-medium text-nexa-elements-textPrimary">Ollama Service</div>
                <div className="text-xs text-nexa-elements-textSecondary mt-0.5">{status.message}</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-nexa-elements-background-depth-3">
                <div
              ...
              <div className="text-[10px] text-nexa-elements-textTertiary flex items-center gap-1.5">
          ...
          <div className="mt-6 flex-1 min-h-0 flex flex-col">
            {status.status === 'Running' && ollamaStatus.models && ollamaStatus.models.length > 0 ? (
              <>
                <div className="text-xs font-medium text-nexa-elements-textSecondary flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                ...
                <div className="overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-600">
                  <div className="grid grid-cols-2 gap-3 pr-2">
                    {ollamaStatus.models.map((model) => (
                      <div
                        key={model.name}
                        className="text-sm bg-nexa-elements-background-depth-3 hover:bg-nexa-elements-background-depth-4 rounded-lg px-4 py-3 flex items-center justify-between transition-colors group"
                      >
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="flex flex-col items-center gap-3 max-w-[280px] text-center">
                  ...
                  />
                  <span className="text-sm text-nexa-elements-textSecondary">{status.message}</span>
                </div>
              </div>
            )}
          </div>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-nexa-elements-textPrimary">System Information</h3>
            </div>
            <div
              className={classNames(
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {systemInfo ? (
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:desktop text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">OS: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.os}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:device-mobile text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Platform: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.platform}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:circuitry text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Architecture: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.arch}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:cpu text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">CPU Cores: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.cpus}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:graph text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Node Version: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.node}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:wifi-high text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Network Type: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {systemInfo.network.type} ({systemInfo.network.effectiveType})
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:gauge text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Network Speed: </span>
                    <span className="text-nexa-elements-textPrimary">
                  ...
                  {systemInfo.battery && (
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:battery-charging text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Battery: </span>
                      <span className="text-nexa-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:hard-drive text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Storage: </span>
                    <span className="text-nexa-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:database text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Memory Usage: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {systemInfo.memory.used} / {systemInfo.memory.total} ({systemInfo.memory.percentage}%)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:browser text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Browser: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {systemInfo.browser.name} {systemInfo.browser.version}
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:monitor text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Screen: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {systemInfo.screen.width}x{systemInfo.screen.height} ({systemInfo.screen.pixelRatio}x)
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:clock text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Timezone: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.time.timezone}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:translate text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Language: </span>
                    <span className="text-nexa-elements-textPrimary">{systemInfo.browser.language}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:chart-pie text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">JS Heap: </span>
                    <span className="text-nexa-elements-textPrimary">
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:timer text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">Page Load: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <div className="i-ph:code text-nexa-elements-textSecondary w-4 h-4" />
                    <span className="text-nexa-elements-textSecondary">DOM Ready: </span>
                    <span className="text-nexa-elements-textPrimary">
              ...
              <div className="text-sm text-nexa-elements-textSecondary">Loading system information...</div>
            )}
          </div>
        </CollapsibleContent>
      </Collapsible>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-nexa-elements-textPrimary">Performance Metrics</h3>
            </div>
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 transform transition-transform duration-200',
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Page Load Time: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {(systemInfo.performance.timing.loadTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">DOM Ready Time: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {(systemInfo.performance.timing.domReadyTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Request Time: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {(systemInfo.performance.timing.requestTime / 1000).toFixed(2)}s
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Redirect Time: </span>
                    <span className="text-nexa-elements-textPrimary">
                ...
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">JS Heap Usage: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {(systemInfo.performance.memory.usedJSHeapSize / (1024 * 1024)).toFixed(1)}MB /{' '}
                      {(systemInfo.performance.memory.totalJSHeapSize / (1024 * 1024)).toFixed(1)}MB
                    </span>
                  ...
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Heap Utilization: </span>
                    <span className="text-nexa-elements-textPrimary">
                      {systemInfo.performance.memory.usagePercentage.toFixed(1)}%
                    </span>
                  </div>
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Navigation Type: </span>
                    <span className="text-nexa-elements-textPrimary">
                  ...
                  <div className="text-sm">
                    <span className="text-nexa-elements-textSecondary">Redirects: </span>
                    <span className="text-nexa-elements-textPrimary">
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-nexa-elements-textPrimary">WebApp Information</h3>
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            {loading.webAppInfo ? (
              ...
              <div className="flex flex-col items-center justify-center p-8 text-nexa-elements-textSecondary">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="mb-4 text-base font-medium text-nexa-elements-textPrimary">Basic Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:app-window text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Name:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.name}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:tag text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Version:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.version}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:certificate text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">License:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.license}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:cloud text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Environment:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.environment}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:graph text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Node Version:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.runtimeInfo.nodeVersion}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="mb-4 text-base font-medium text-nexa-elements-textPrimary">Git Information</h3>
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-branch text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Branch:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.gitInfo.local.branch}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:git-commit text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Commit:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.gitInfo.local.commitHash}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:user text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Author:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.gitInfo.local.author}</span>
                    </div>
                    <div className="text-sm flex items-center gap-2">
                      <div className="i-ph:clock text-nexa-elements-textSecondary w-4 h-4" />
                      <span className="text-nexa-elements-textSecondary">Commit Time:</span>
                      <span className="text-nexa-elements-textPrimary">{webAppInfo.gitInfo.local.commitTime}</span>
                    </div>
                    ...
                    {webAppInfo.gitInfo.github && (
                      <>
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                          <div className="text-sm flex items-center gap-2">
                            <div className="i-ph:git-fork text-nexa-elements-textSecondary w-4 h-4" />
                            <span className="text-nexa-elements-textSecondary">Repository:</span>
                            <span className="text-nexa-elements-textPrimary">
                          ...
                          <div className="mt-2 flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-nexa-elements-textSecondary">
                        ...
                        {webAppInfo.gitInfo.github.upstream && (
                          <div className="mt-2">
                            <div className="text-sm flex items-center gap-2">
                              <div className="i-ph:git-fork text-nexa-elements-textSecondary w-4 h-4" />
                              <span className="text-nexa-elements-textSecondary">Upstream:</span>
                              <span className="text-nexa-elements-textPrimary">
            ...
            {webAppInfo && (
              <div className="mt-6">
                <h3 className="mb-4 text-base font-medium text-nexa-elements-textPrimary">Dependencies</h3>
        ...
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-medium text-nexa-elements-textPrimary">Error Check</h3>
              {errorLogs.length > 0 && (
          ...
          <div className="p-6 mt-2 rounded-xl bg-white dark:bg-[#0A0A0A] border border-[#E5E5E5] dark:border-[#1A1A1A]">
            <ScrollArea className="h-[300px]">
              <div className="space-y-4">
                ...
                <div className="text-sm">
                  <span className="text-nexa-elements-textSecondary">Status: </span>
                  <span className="text-nexa-elements-textPrimary">
                    {loading.errors
                      ? 'Checking...'
                      : errorLogs.length > 0
                ...
                {errorLogs.length > 0 && (
                  <div className="mt-4">
                    <div className="text-sm font-medium text-nexa-elements-textPrimary mb-2">Recent Errors:</div>
                    <div className="space-y-2">
                      {errorLogs.map((error) => (
