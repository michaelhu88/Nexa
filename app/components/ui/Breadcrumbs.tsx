      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-nexa-elements-textPrimary dark:text-nexa-elements-textPrimary-dark'
              : 'text-nexa-elements-textSecondary dark:text-nexa-elements-textSecondary-dark hover:text-nexa-elements-textPrimary dark:hover:text-nexa-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-nexa-elements-textTertiary dark:text-nexa-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
