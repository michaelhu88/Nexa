  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-nexa-elements-borderColor bg-nexa-elements-background-depth-1 text-nexa-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-nexa-elements-textSecondary', className)} {...props} />;
  },
);
