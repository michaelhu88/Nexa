      ...
      <div className={classNames('relative flex items-center w-full', containerClassName)}>
        ...
        <div
          className={classNames(
            'absolute left-3 top-1/2 -translate-y-1/2 text-nexa-elements-textTertiary',
            iconClassName,
          )}
        >
          {loading ? (
        ...
        <AnimatePresence>
          {hasValue && showClearButton && (
            <motion.button
              ...
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-nexa-elements-textTertiary hover:text-nexa-elements-textSecondary p-1 rounded-full hover:bg-nexa-elements-background-depth-2"
