      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-nexa-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-nexa-elements-item-backgroundAccent hover:bg-nexa-elements-artifacts-backgroundHover"
